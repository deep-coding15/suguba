...
export default function ProduitItemsListView({ item }) {
  ...
  return (
    <>
    <div className="ProduitItems shadow-lg rounded-md overflow-hidden border border-[rgba(0,0,0,0.1)] flex items-center">
      <div className="group Pitems w-[25%] h-[220px] rounded-md overflow-hidden relative z-0">
        ...
        {item.discount > 0 && (
          <span className="promo flex items-center absolute top-[10%] left-[10%] z-10 !bg-pink-400 text-white rounded-lg p-1 text-[15px] font-[500]">
            -{item.discount}%
          </span>
        )}

        <div className="actions absolute top-[-20px] right-[5px] z-10 flex items-center gap-2 flex-col w-[50px] transition-all duration-300 group-hover:top-[15px] opacity-0 group-hover:opacity-100">
          <Button
          ...
          <Button  className={`!w-[35px] !h-[35px] !min-w-[35px] !rounded-full hover:!bg-pink-400 group ${isInCompare ? "!bg-pink-400" : "!bg-white"}`}
      ...
      <div className="Pinfos w-[75%] p-3 py-5 !px-8">
        <h6 className="text-[15px]">
          <Link to={`/produit/${item._id}`} className="link transition-all">
            {item.catName}
          </Link>
        </h6>
        <h3 className="text-[18px] descrip mt-1 font-[500] mb-1 text-[#000]">
          <Link to={`/produit/${item._id}`} className="link transition-all">
            {item.name}
          </Link>
        </h3>
        <p className="text-[14px] !mb-3">{item.description?.slice(0, 120)}...</p>
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="nouveauPrix text-[rgb(231,116,146)] text-[15px] font-[600]">
...
import { MyContext } from "../../../router";
export default function ProduitItemsListView (){
     const context =useContext(MyContext);
return(
    <div className="ProduitItems shadow-lg rounded-md overflow-hidden border border-[rgba(0,0,0,0.1)] flex items-center">
        
          <div className=" group Pitems w-[25%] h-[220px] rounded-md overflow-hidden relative">
            <Link to="/">
              <div className="img h-[220px] overflow-hidden">
                <img src="https://imgs.search.brave.com/cUe901OCa3DPEa0_UlfgHA_zUrpWlG0-6wBfUPz2DEs/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tLm1l/ZGlhLWFtYXpvbi5j/b20vaW1hZ2VzL0kv/NTEyTWNvWE5YcEwu/anBn"
                 ...
                 <div className="actions absolute top-[-20px] right-[5px] z-50 flex items-center
          ...
          <div className="Pinfos  w-[75%] p-3 py-5 !px-8">
            ...
            <p className="text-[14px] !mb-3"> une description pour cette belle robe
                digne dune magnifique et rayonnante demoiselle prete a faire craquer plus dun homme
            </p>
            <Rating name="size-small" defaultValue={4} size="small" readOnly/>
    
            <div className="flex items-center gap-4" >
                <span className="ancienPrix line-through text-gray-500 text-[15px] font-[500]">25 000Fcfa</span>
                <span className="nouveauPrix text-[rgb(231, 116, 146)] text-[15px] font-[600]">15 000Fcfa</span>
            </div>
            <div className="!mt-3">
                <Button className="btn-org flex gap-2">
                    <MdOutlineShoppingCart className="text-[20px]"/>Ajouter au panier</Button>
            </div>
</div>
</div>
)}*/}